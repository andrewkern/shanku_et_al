...
func = dadiFunctions.IM_misorient_noMig_admix
#params = (nu1_0,nu2_0,nu1,nu2,T,t_ad,p_ad,p_misid)


params = [  1.53508047e+00,   2.01954315e-01,   7.05672270e+00,
         1.04123880e+00,   2.43171832e-01,   8.02383249e-04,   9.52992145e-06,
         2.92856419e-02]
upper_bound = [20,1,20, 10, 2, 0.15,0.5,0.25]
...
opt_prob.addVar('p_misid','c',lower=lower_bound[7],upper=upper_bound[7],value=p1[7])
opt_prob.addObj('f')
...
if myrank == 0:
	...
	print 'Nref:',Nref
	paramsTxt =['nu1_0','nu2_0','nu1','nu2','T','t_ad','p_ad','p_misid']
	scaledParams = [Nref*popt[0],Nref*popt[1],Nref*popt[2],Nref*popt[3],2*Nref/15*popt[4],2*Nref/15*popt[5],popt[6],popt[7]]
